...
var ODataRequest = /** @class */ (function () {
    function ODataRequest(client, config, method, entity, id) {
        ...
        this.client = client;
        this.config = __assign(__assign({}, config), { cancelToken: this.cancelTokenSource.token, method: method, params: {}, url: entity });
        if (id != null) {
            this.config.url += "(" + id + ")";
        }
    }
    ODataRequest.prototype.clone = function () {
        ...
        request.config = __assign(__assign({}, lodash_1.cloneDeep(this.config)), { cancelToken: request.cancelTokenSource.token });
        return request;
    };
    ...
    ODataRequest.prototype.orderby = function (orderby, direction) {
        if (this.config.method !== "GET") {
    ...
    ODataRequest.prototype.top = function (top) {
        if (this.config.method !== "GET") {
    ...
    ODataRequest.prototype.skip = function (skip) {
        if (this.config.method !== "GET") {
    ...
    ODataRequest.prototype.count = function (count) {
        if (this.config.method !== "GET") {
    ...
    ODataRequest.prototype.search = function (search) {
        if (this.config.method !== "GET") {
    ...
    ODataRequest.prototype.param = function (key, value) {
